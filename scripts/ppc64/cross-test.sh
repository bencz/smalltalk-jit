...
for cpu in $CPUS; do
	...
	for t in tests/AtomicTest.st tests/FloatTest.st tests/FloatEdgeTest.st tests/FloatCrossRepTest.st \
	         ...
	         tests/InlineControlFlowTest.st \
	         tests/LookupSelectorTest.st tests/ClassExtensionTest.st \
	         tests/TierBooleanGuardTest.st tests/ExoticBooleanTest.st \
	         tests/IntegerPrintStringTest.st tests/IntegerDivisionTest.st; do
